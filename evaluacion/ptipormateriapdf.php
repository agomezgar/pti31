...
$link=Conectarse();
	    ...
	    $result3 = mysql_query("SELECT * FROM pti WHERE (MATERIA='$materia' AND  CALIFICAPTI BETWEEN 0 AND 4 AND CALIFICACION BETWEEN 0 AND 4)  ORDER BY CURSO",$link);
...
$pdf->Multicell(160,5,'PERFIL ACADÉMICO DEL ALUMNO'."\n",1,'C',1);
...
if ($vago2==1){$perfilacademico=$perfilacademico."El profesor considera que el alumno no se esfuerza lo suficiente. \n";}
...
if ($rec132==1){$listacontenidos=$listacontenidos.$b13.": ".$evc132.".\n";}
if ($rec142==1){$listacontenidos=$listacontenidos.$b14.": ".$evc142.".\n";}
if ($rec152==1){$listacontenidos=$listacontenidos.$b15.": ".$evc152.".\n";}
if ($rec162==1){$listacontenidos=$listacontenidos.$b16.": ".$evc162.".\n";}
if ($rec172==1){$listacontenidos=$listacontenidos.$b17.": ".$evc172.".\n";}
if ($rec182==1){$listacontenidos=$listacontenidos.$b18.": ".$evc182.".\n";}
if ($rec192==1){$listacontenidos=$listacontenidos.$b19.": ".$evc192.".\n";}
if ($rec202==1){$listacontenidos=$listacontenidos.$b20.": ".$evc202.".\n";}
